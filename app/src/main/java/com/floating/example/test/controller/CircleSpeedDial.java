 ...
 */
public class CircleSpeedDial extends AbsoluteLayout implements View.OnClickListener, ViewTreeObserver.OnPreDrawListener {
    ...
    public CircleSpeedDial(Context context) {
        super(context);
    }

    public CircleSpeedDial(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleSpeedDial(Context context, AttributeSet attrs, int defStyleAttr) {
